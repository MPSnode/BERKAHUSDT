...
import { 
  ...
  Cpu, HardDrive, Terminal, Power, Wifi, AlertTriangle, Zap, FileCode, ExternalLink, Megaphone, Sparkles
} from 'lucide-react';
...
sudo certbot --nginx -d domainanda.com
          ...
          {activeMenu === 'GRAFIK' && (
            <div className="glass-card p-6 rounded-3xl border border-slate-800 bg-[#061219] font-mono text-xs space-y-3">
              <h3 className="text-lg font-bold text-white font-['Space_Grotesk'] flex items-center gap-2">
                <LineChart className="w-5 h-5 text-emerald-400" /> Pengaturan Grafik Kurs & Chart
              </h3>
              <p className="text-slate-300">Realtime WebSocket Sync dengan TradingView Binance Rate Active</p>
            </div>
          )}
          ...
          {activeMenu === 'BANK' && (
            <div className="glass-card p-6 rounded-3xl border border-slate-800 bg-[#061219] font-mono text-xs space-y-3">
              <h3 className="text-lg font-bold text-white font-['Space_Grotesk'] flex items-center gap-2">
                <Landmark className="w-5 h-5 text-emerald-400" /> Kelola Rekening Bank & QRIS Admin
              </h3>
              <div className="space-y-2 p-4 rounded-2xl bg-[#040A10] border border-slate-800">
                <p className="text-white font-bold">Bank BCA: 8830-1928-11 (a.n. PT Berkah OTC Desk)</p>
                <p className="text-white font-bold">Bank Mandiri: 137-00-19283-00 (a.n. PT Berkah OTC Desk)</p>
                <p className="text-emerald-400 font-bold">QRIS Instant Payment Active</p>
              </div>
            </div>
          )}
